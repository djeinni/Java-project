...
public class CourseRetrievalService {
    ...
    public List<PluralsightCourse> getCoursesFor(String authorId){
        ...
        try {
            ...
            return switch(response.statusCode()){
                case 200 -> toGetPluralsightCourses(response);
                case 404 -> List.of();
    ...
    private static List<PluralsightCourse> toGetPluralsightCourses(HttpResponse<String> response) throws JsonProcessingException {
